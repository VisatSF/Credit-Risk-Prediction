...
├── notebooks/
│   ├── eda-vietnamese.ipynb        # Notebook EDA (Tiếng Việt)
│   ├── eda-english.ipynb           # Notebook EDA (Tiếng Anh)
│   └── eda-enhanced.ipynb          # Notebook EDA nâng cao
...
| 5 | `loan_intent` | object | Mục đích vay (PERSONAL, EDUCATION, MEDICAL, VENTURE, DEBTCONSOLIDATION, HOMEIMPROVEMENT) |
...
| **scikit-learn** | Tiền xử lý dữ liệu & mô hình ML (Logistic Regression, Random Forest) |
